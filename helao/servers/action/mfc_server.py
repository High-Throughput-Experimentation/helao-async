...
async def mfc_dyn_endpoints(app=None):
    ...
    dev_names = list(app.driver.fcs.keys())
    ...
    if co2_sensor_key in app.helao_cfg["servers"]:
        ...
        async def maintain_concentration(
            ...
            device_name: app.driver.dev_mfcs = dev_names[0],
