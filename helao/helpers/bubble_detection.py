...
def bubble_detection(data: pd.DataFrame, RSD_threshold: float, simple_threshold: float, signal_change_threshold: float, amplitude_threshold: float):
    ...
    return RSD_test_result, simple_test_result, signal_change_result, amplitude_test_result
    ...
    # print("total test results: " + str(RSD_test_result or simple_test_result or signal_change_result or amplitude_test_result))
