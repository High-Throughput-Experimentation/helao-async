...
__all__ = [
    ...
    "UVIS_CP",
    "UVIS_CP_led",
    "UVIS_CV_led_spectrometer",
    "UVIS_CA_led_spectrometer",
    "UVIS_CP_led_spectrometer",
    "UVIS_movetosample",
    "UVIS_move",
]
...
def UVIS_CA_led_spectrometer(
    ...
    for plate_sample in plate_sample_no_list:
        ...
        # CA1
        pl.add_experiment(
            "UVIS_slave_CA_led_secondtrigger",
            {
                "CA_potential_vsRHE": CA_potential_vsRHE,
                "solution_ph": solution_ph,
                "reservoir_liquid_sample_no": reservoir_liquid_sample_no,  # currently liquid sample database number
...
def UVIS_CP_led_spectrometer(
    ...
    for plate_sample in plate_sample_no_list:
        ...
        # CP1
        pl.add_experiment(
            "UVIS_slave_CP_led_secondtrigger",
            {
                "CP_current": CP_current,
                "solution_ph": solution_ph,
                "reservoir_liquid_sample_no": reservoir_liquid_sample_no,  # currently liquid sample database number
