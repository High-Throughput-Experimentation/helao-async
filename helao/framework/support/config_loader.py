...
Importing this module is side-effect-free: :data:`CONFIG` is ``None`` until an
explicit :func:`load_global_config` call with ``set_global=True``.
"""
