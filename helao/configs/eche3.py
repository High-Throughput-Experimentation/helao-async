...
config["sequence_params"] = {
    ...
    "led_intensities_mw": [2.4, 2.62, 1.2, 0],
...
config["servers"] = {
    ...
    "MOTOR": {
        ...
        "params": {
            ...
            "count_to_mm": {"A": 0.00015618313409571528, "B": 0.00015618776893581464},
            "galil_ip_str": "192.168.200.229",
            "def_speed_count_sec": 10000,
            "max_speed_count_sec": 25000,
            "ipstr": "192.168.200.23",
            "axis_id": {"x": "B", "y": "A"},
            "axis_zero": {"A": 127, "B": 76.9},
            "timeout": 600,
        },
    },
    "PSTAT": {
    ...
    "VIS": {
        ...
        "params": {"doc_name": "ECHE3 Visualizer"},
    },
    "DB": {
        "host": "127.0.0.1",
        "port": 8010,
