"""Hexagon-composed TEC action server (P3b): wraps hte's legacy
tec_server makeApp through the hexagon factory (fail-loud wiring + co-located
...
LEGACY_MODULE = "helao.deploy.hte.servers.action.tec_server"
