"""Hexagon-composed syringe pump action server (P3b): wraps hte's legacy
syringe_server makeApp through the hexagon factory (fail-loud wiring + co-located
...
LEGACY_MODULE = "helao.deploy.hte.servers.action.syringe_server"
