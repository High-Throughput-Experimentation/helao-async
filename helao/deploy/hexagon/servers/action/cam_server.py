"""Hexagon-composed camera action server (P3b): wraps hte's legacy
cam_server makeApp through the hexagon factory (fail-loud wiring + co-located
...
LEGACY_MODULE = "helao.deploy.hte.servers.action.cam_server"
