"""Hexagon-composed spectrometer action server (P3b): wraps hte's legacy
spec_server makeApp through the hexagon factory (fail-loud wiring + co-located
...
LEGACY_MODULE = "helao.deploy.hte.servers.action.spec_server"
