"""Hexagon-composed NI-DAQmx action server (P3b): wraps hte's legacy
nidaqmx_server makeApp through the hexagon factory (fail-loud wiring + co-located
...
LEGACY_MODULE = "helao.deploy.hte.servers.action.nidaqmx_server"
