"""Hexagon-composed calc action server (P3b): wraps hte's legacy
calc_server makeApp through the hexagon factory (fail-loud wiring + co-located
...
LEGACY_MODULE = "helao.deploy.hte.servers.action.calc_server"
