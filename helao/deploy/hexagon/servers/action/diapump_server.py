"""Hexagon-composed dia pump action server (P3b): wraps hte's legacy
diapump_server makeApp through the hexagon factory (fail-loud wiring + co-located
...
LEGACY_MODULE = "helao.deploy.hte.servers.action.diapump_server"
