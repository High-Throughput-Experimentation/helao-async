"""Hexagon-composed PDU action server (P3b): wraps hte's legacy
pdu_server makeApp through the hexagon factory (fail-loud wiring + co-located
...
LEGACY_MODULE = "helao.deploy.hte.servers.action.pdu_server"
