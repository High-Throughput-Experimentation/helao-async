"""Hexagon-composed HTEdata action server (P3b): wraps hte's legacy
HTEdata_server makeApp through the hexagon factory (fail-loud wiring + co-located
...
LEGACY_MODULE = "helao.deploy.hte.servers.action.HTEdata_server"
