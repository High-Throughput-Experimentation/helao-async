"""Hexagon-composed Galil IO action server (P3b): wraps hte's legacy
galil_io makeApp through the hexagon factory (fail-loud wiring + co-located
...
LEGACY_MODULE = "helao.deploy.hte.servers.action.galil_io"
