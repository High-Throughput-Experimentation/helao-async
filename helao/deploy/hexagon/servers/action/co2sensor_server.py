"""Hexagon-composed CO2 sensor action server (P3b): wraps hte's legacy
co2sensor_server makeApp through the hexagon factory (fail-loud wiring + co-located
...
LEGACY_MODULE = "helao.deploy.hte.servers.action.co2sensor_server"
