"""Hexagon-composed Biologic potentiostat action server (P3b): wraps hte's legacy
biologic_server makeApp through the hexagon factory (fail-loud wiring + co-located
...
LEGACY_MODULE = "helao.deploy.hte.servers.action.biologic_server"
