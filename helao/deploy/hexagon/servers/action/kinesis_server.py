"""Hexagon-composed Kinesis motor action server (P3b): wraps hte's legacy
kinesis_server makeApp through the hexagon factory (fail-loud wiring + co-located
...
LEGACY_MODULE = "helao.deploy.hte.servers.action.kinesis_server"
