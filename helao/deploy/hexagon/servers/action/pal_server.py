"""Hexagon-composed PAL sampler action server (P3b): wraps hte's legacy
pal_server makeApp through the hexagon factory (fail-loud wiring + co-located
...
LEGACY_MODULE = "helao.deploy.hte.servers.action.pal_server"
