"""Hexagon-composed sync_server action server (P3b-2): wraps hte's legacy
sync_server makeApp through the hexagon factory (fail-loud wiring + co-located
...
LEGACY_MODULE = "helao.deploy.hte.servers.action.sync_server"
