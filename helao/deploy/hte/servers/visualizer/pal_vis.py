    ...
    def __init__(self, vis_serv: Vis, serv_key: str):
        ...
        self.sample_tables = {
            smptype: DataTable(
                ...
                # after pal_vis (e.g. spec_vis) silently disappears. "force_fit"
                # fits columns to the table width without the content-size
                # autosize path (matches the operator's working DataTables).
