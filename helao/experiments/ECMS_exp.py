...
def ECMS_sub_electrolyte_fill_cell(
    ...
    apm.add(NI_server, "pump", {"pump": "RecirculatingPeriPump2", "Direction": 0})
    apm.add(ORCH_server, "wait", {"waittime": apm.pars.liquid_forward_time})
    apm.add(NI_server, "pump", {"pump": "RecirculatingPeriPump2", "Direction": 1})
...
def ECMS_sub_drain(
    ...
    apm.add(NI_server, "pump", {"pump": "RecirculatingPeriPump1", "Direction": 1})
