...
def SIM_measure_CP(
    ...
    apm.add(
        ...
        _to_globalexp_params=["_plate_id"],
    )
    # load plate
    apm.add(
        PAL_server,
        "load_space",
        {},
        _from_globalexp_params={"_plate_id": "plate_id"},
        _to_globalexp_params=["_ph", "_elements"],
    )
    ...
    apm.add(
        ...
        _to_globalexp_params=["_acq_sample_no"],
    )
    ...
    apm.add(
        ...
        {},
        _from_globalexp_params={"_plate_id": "plate_id", "_acq_sample_no": "sample_no"},
        _to_globalexp_params=["_platexy"],
    )
    # move stage motors to sample x,y
    apm.add(MOTOR_server, "move", {}, _from_globalexp_params={"_platexy": "d_mm"})
