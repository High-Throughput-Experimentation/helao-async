...
def UVIS_sub_measure(
    ...
    apm.add(
        ...
        {"custom": "cell1_we"},
        _to_globalexp_params=["_fast_samples_in"],
    )
...
def UVIS_sub_setup_ref(
    ...
    if apm.pars.reference_mode == "internal":
        apm.add(
            ...
            _to_globalexp_params=["_refno", "_refxy"],
        )
        apm.add(
            PAL_server,
            ...
            _from_globalexp_params={"_refno": "sample_no"},
        )
        ...
        apm.add(
            ...
            _to_globalexp_params={"_platexy": "_refxy"},
        )
    # move to position
    apm.add(
        MOTOR_server,
        ...
        _from_globalexp_params={"_refxy": "d_mm"},
    )
    return apm.action_list  # returns complete action list to orch
