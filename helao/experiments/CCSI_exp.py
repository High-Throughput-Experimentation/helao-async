...
CALC_server = MachineModel(server_name="CALC", machine_name=ORCH_HOST).clean_dict()
CO2S_server = MachineModel(server_name="CO2SENSOR", machine_name=ORCH_HOST).clean_dict()
