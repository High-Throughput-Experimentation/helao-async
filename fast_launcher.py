...
if __name__ == "__main__":
    ...
    makeApp = import_module(f"helao.servers.{server_config['group']}.{server_config['fast']}").makeApp
    ...
    fastapp = uvicorn.run(app, host=server_config["host"], port=server_config["port"], log_level="warning")
